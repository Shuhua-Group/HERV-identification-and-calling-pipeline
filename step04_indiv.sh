#!/usr/bin/bash
#cmd: bash step04_indiv.sh /PATH/TO/YOUR.config sampleID
#echo "The script is under revision. Please wait for the release in near future.";exit


if [[ $2 = "" ]];then
	echo "Usage: bash step04_indiv.sh /PATH/TO/YOUR.config sampleID";exit
fi
...
bash ${postERVcaller}/scripts/s1p1.sh $configPath $2 || echo "Step04 failed."
